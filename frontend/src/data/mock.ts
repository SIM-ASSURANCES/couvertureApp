...
export const partenaires: Partenaire[] = [
  ...
  },
  {
    ...
    produitAccident: true,
    statut: "inactif",
    email: "accessoiremarcory@example.com",
...
export const clientsIncendie: ClientIncendie[] = [
  {
    ...
    partenaireNom: "Vulcano Service Cocody",
    telephone: "+225 07 09 10 11 12",
    nom: "Kouassi",
    prenom: "Marie",
    refFacture: "FAC-2025-8841",
    montantPrime: 1000,
    capitalGaranti: 2000000,
    statut: "complet",
  ...
  },
  {
    ...
    partenaireNom: "Accessoire Auto Marcory",
    telephone: "+225 07 77 88 99 00",
    nom: "Touré",
    prenom: "Ibrahim",
    refFacture: "FAC-2025-7720",
    montantPrime: 1000,
    capitalGaranti: 2000000,
    statut: "expire",
...
export const clientsAccident: ClientAccident[] = [
  ...
  },
  {
    ...
    partenaireNom: "Garage Mécanique Yopougon",
